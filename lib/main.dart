          ...
          child: Column(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Cashier App', style: TextStyle(
                    fontSize: 26,
                    fontWeight: FontWeight.w300,
                  ),
                  ),
                  Text('Semoga Harimu Menyenangkan', style: TextStyle(
                    fontSize: 16,
              ...
              Expanded(
                    child: Padding(padding: EdgeInsets.only(bottom: 75),
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text("Rp. ${products[index]['price']}", style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w300,
                                        ),
                                        ),
                                    
                                        Text("Stock: ${products[index]['stock']}", style: TextStyle(
                                          fontSize: 13,
                                          fontWeight: FontWeight.w300,
                                        ),
                                        ),
            ...
            child: Align(
              ...
              child:  Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Total item: $totalItems Item, Rp. $totalPrice", style: TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                      fontWeight: FontWeight.w500,
                    ),
